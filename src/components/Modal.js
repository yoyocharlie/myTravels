...
const Modal = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        // form handling here
        // submit form info to firestore DB
    }

  return (
    <>
        <div className="absolute w-screen h-screen bg-black opacity-40 left-0 top-0"></div>
        <div>
                        ...
                        <div className="py-6 px-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={onSubmit}>
                                <div>
                                    ...
                                    <input accept="image/*" type="file" name="image" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" name="location" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="where did you go?" />
                                    </div>
                                </div>
                                <div>  
                                ...
                                <div>
                                    ...
                                    <textarea maxLength='100' name="description" placeholder="write about your adventure :)" className="max-h-20 resize-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                </div>
                                <button type="submit" className="w-full text-white bg-pinkishRed hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-400 dark:hover:bg-red-400 dark:focus:red-400">Save Trip</button>
                            </form>
                        </div>
                    </div>
                </div>
